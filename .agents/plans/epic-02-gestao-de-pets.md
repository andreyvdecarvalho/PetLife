...
- [x] Cadastro com nome e espécie obrigatórios (mínimo).
- [x] Listagem de raças carregada via autocomplete pela espécie.
- [x] Compressão local da foto do pet para <= 500KB.
- [x] Arquivamento remove o pet da lista principal mas permite restauração.
- [x] Bloqueio de criação do 3º pet para usuários Free.
