# Architecture Decision Records (ADRs) — PetLife

Este diretório contém os registros de decisões arquiteturais do projeto **PetLife**, servindo como documentação histórica dos porquês de determinadas escolhas tecnológicas e padrões estruturais.

## Índice de ADRs

| ID | Título | Status | Data |
|---|---|---|---|
| [ADR-001](ADR-001-monorepo-pnpm.md) | [Arquitetura de Monorepo com PNPM Workspaces](ADR-001-monorepo-pnpm.md) | **Aprovado** | 30/06/2026 |
| [ADR-002](ADR-002-atomic-design-vanilla-css.md) | [Metodologia Atomic Design e Vanilla CSS no Frontend Web](ADR-002-atomic-design-vanilla-css.md) | **Aprovado** | 30/06/2026 |
