...
export function VetProfileDashboard() {
  ...
  if (error && !vet) return <div className="organism-vet-profile-dashboard__error">{error}</div>;
  if (!vet) return <div>Perfil não encontrado.</div>;

  return (
    <div className="organism-vet-profile-dashboard">
      <section className="organism-vet-profile-dashboard__section">
        <h2>Dados Básicos</h2>
      ...
      <section className="organism-vet-profile-dashboard__section">
        <h2>Controles</h2>
        <div className="organism-vet-profile-dashboard__controls">
